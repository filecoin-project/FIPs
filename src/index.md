...
{% comment %}
<!-- TO DO -->
Loop through and grab this from FIPs folder
{% endcomment %}

|FIP #   | Title  | Author  | Status  |
|---|---|---|---|
|[0001](/FIPS/fip-0001/)   | FIP Purpose and Guidelines  | @Whyrusleeping  | Active  |
...
|[0003](/FIPS/fip-0003/)   | Filecoin Plus Principles  | @feerst, @jbenet, @jnthnvctr, @tim-murmuration, @mzargham, @zixuanzh  |Draft   |
...
|[0015](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0015.md)   |  Revert FIP-0009(Exempt Window PoSts from BaseFee burn) | @jennijuju, @arajasek |Accepted   |
