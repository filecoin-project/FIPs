...
23:       ticket ← VRF(Randomness(baseChain) || instance || round )
24:       value ← proposal \* set local proposal as value in CONVERGE message
25:       BEBroadcast <CONVERGE, value, instance, round, evidence, ticket>; trigger(timeout)
...
32:       BEBroadcast <PREPARE, value, instance, round>; trigger(timeout)
...
40:     BEBroadcast <COMMIT, value, instance, evidence, round>; trigger(timeout)
...
57:     decideSent ← True
58:     BEBroadcast <DECIDE, value, instance, evidence>
59:     go to line 54
```
