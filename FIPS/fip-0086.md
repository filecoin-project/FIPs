...
33:     BEBroadcast <PREPARE, value, instance, round, evidence>; trigger(timeout) \* evidence is nil in round=0
...
45:       BEBroadcast <DECIDE, StrongQuorumValue(M), instance, evidence>
...
59:	  decideSent ← TRUE
60:	  BEBroadcast <DECIDE, v, instance, evidence)
61:	  go to line 56. 
```
