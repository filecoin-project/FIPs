...
82:     				case COMMIT:
83:        					BEBroadcast(latest_broadcast[COMMIT]) \* no break, cascade to broadcast PREPARE, CONVERGE, QUALITY also
84:     				case PREPARE:
85:						BEBroadcast(latest_broadcast[PREPARE]) \* no break, cascade to broadcast CONVERGE, QUALITY also
