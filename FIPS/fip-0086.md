...
68:   if Power(M') + (1-Power(M)) < ⅔ - advPower  : \* value cannot have been decided 
69      return False
70:   return True
```
...
107:    round ← msg.round;
108:    timeout ← 2*Δ*backOffExponent**msg.round
...
115: shouldJump(round, step, timeout): 
