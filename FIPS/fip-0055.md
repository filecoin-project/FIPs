...
It also introduces the **Ethereum Account** built-in actor to represent Ethereum Externally Owned accounts, capable of acting as message senders, and a new **Delegated signature type**, which enables validating native [EIP-1559 Ethereum transaction]s carrying an secp256k1 ECDSA signatures over their RLP encoding.
