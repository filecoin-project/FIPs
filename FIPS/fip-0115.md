...
### GasEstimateGasPremium and `eth_maxPriorityFeePerGas`

These methods are used to suggest GasPremium to users before they sign transactions.
`eth_maxPriorityFeePerGas` SHOULD return to GasEstimateGasPremium with `nblocksincl = 1` and `gaslimit = 20000`.
