...
This FIP is designed to accompany FIP-0030 and FIP-0031 under the same network upgrade. Taken together, these three FIPs represent the theory and process of change for introducing an FVM with non-programmable smart contracts. 

The second gas change FIP will be proposed and considered at a later date in order to support the introduction of user-programmable smart contracts during phase 2 of FVM roll-out. 
