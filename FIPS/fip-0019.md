...
The aim of the encoding function is to allow encoding data into an exising sector key without breaking
the compressability assumption of PoRep.
...
...
This change is not backwards compatible and will require a network upgrade.
