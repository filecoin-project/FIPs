...
- Some other consideration related to **ChangeBeneficiary**: 
    - A succssful **ChangeOwnerAddress** will invalidate any **pendingBeneficiaryTerm**, which means, a non-fully approved **ChangeBeneficiary** will be deleted whenever the **Owner** address changes
