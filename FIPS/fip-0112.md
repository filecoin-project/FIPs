...
This method takes in a sector number, generic serialized bytes encoding a sector location and the status of the sector, either `Live`, `Dead`, or `Faulty`.  It returns true if the correct sector status is passed.
