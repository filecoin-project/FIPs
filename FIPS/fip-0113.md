...
Implementations should not introduce a special syscall/pricelist gas charge for this operation. Execution is charged via FEVM’s normal instrumented Wasm instruction accounting, so the observed cost depends on the Wasm-level execution cost of the precompile implementation.
