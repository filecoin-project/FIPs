...
This change enables multisig and payment channel actors to receive value from EVM runtime actors (i.e. smart contracts), Eth accounts, and placeholders.
...
This change is needed to normalise interactions from EVM runtime actors (i.e. smart contracts), Eth accounts, and placeholders with multisigs and payment .
...
Improves the interoperability of multisigs and payment channel actors with Filecoin EVM runtime actors (i.e. smart contracts), Eth accounts, and placeholders.
