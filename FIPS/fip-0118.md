...
| `REGISTRATION_CUTOFF` | Late-claim guard: a registration in the last cutoff of a quarter applies from the boundary (Section 2.2) | Governance parameter | Parameter events | 7 days | Next quarter boundary | None |
