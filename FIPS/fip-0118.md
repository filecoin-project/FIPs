...
changes to leader election or finality.
  ...
  - **Removing the sole Orchestrator burns the whole service stream
    ...
    payment lags measurement by construction: a successor admitted
    in the removal's quarter Q enters the share map about ten days
    into Q+2, through a later `SubmitShares`, never a mid-quarter
    push (Sections 3.2 and 2.4.4). No lever is faster, and none
