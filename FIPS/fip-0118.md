...
divided among Orchestrators. In particular,
  ...
  - The SRA holds the registry (the (payer, operator) to Orchestrator
    ...
    259,200-epoch quarters (90 days at 30-second epochs), 3 days of
    posting and 7 days of verification; the activation epoch and the
    hold duration are set with the activation parameters (TODO); the
    admitted-stablecoin
