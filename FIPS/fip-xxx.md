...
## Simple Summary
Add a time based weighted averaging of the block sizes for the base-fee calculation. Specifically, the weights correspond to a gepmetric series.
