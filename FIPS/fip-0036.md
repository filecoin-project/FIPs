...
- The minimum sector duration time will increase from 6 months to 1 year and the maximum sector duration will increase from 1.5 years to 3.5 years. This change to maximum sector expiration duration **will be implemented gradually**: we propose increasing the maximum duration by 6 months every week for 4 weeks, until the maximum duration of 3.5 years is available. 
