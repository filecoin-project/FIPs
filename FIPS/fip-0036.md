...
```
1. advPower = advFILplus * FILplusMultiplier * durationMultiplier * powerOnboarding * FILplusPct
2. advPower =  0.5 * 10 * (2 * 5) * 50 * 0.05$
3. honestPower = 0.5 * 10 * (2 * 5) * 50 \cdot * + 0.5 * 1 * (2 * 1) * 50 *t 0.95
4. advPowerDailyPctGain = advPower/(18,000 + advPower + honestPower) 
