...
## Introduction 
It is no secret that this FIP has been passionately debated, adjusted, tweaked, tuned, and iterated upon over the course of the past couple of months. CryptoEconLab is incredibly appreciative and suportive of the detailed and thoughtful discussion our community continues to have surrounding this FIP, and, hope this level of informed and thoughtful discussion continues for future Filecoin Improvement Proposals (regardless of their ultimate inclusion in the protocols). As ZX put it e[arlier](https://github.com/filecoin-project/FIPs/discussions/421#discussioncomment-3516156), "as all FIPs in Filecoin, it should never be us vs them. We are all part of the Filecoin community. It should be about how to make Filecoin better as a whole. This is the principle of CryptoEconLab and its network of teams and collaborators."

The updates to the FIP draft below reflect the work of CryptoEconLab and its network of contributors to propose community centered solutions, while also understanding that the health, stability, and prosperity of an economy as well as its contributing participants. The macroeconomic commentary [here](https://github.com/filecoin-project/FIPs/discussions/421#discussioncomment-3516156) can help provide some shared context for us admist navigating this FIP, its potential inclusion in upcoming upgrades, and, why many believe in strong net benefits to this a version of this policies inclusion in the upcoming network upgrade nv17, pending community support and acceptance. 
...
We propose a maximum sector commitment of 3.5 years. This is an increase from the current maximum sector commitment of 540 days. Note, the protocol currently sets a maximum sector **lifetime** to 5 years (i.e sectors can be extended up to 5 years). This FIP would not adjust that. CryptoEconLab had originally suggested increasing the maximum sector duration to 5-years, in line with the maximum extenion lifetime for a sector. The community (particularly many storage providers) expressed a desire that these changes roll out more gradually, be monitored, and then adjusted accordingly in subsequent network upgrades. If this policy were to enter the network, CryptoEconLab has robust monitoring in place to investigate storage onboarding, sectors/deal durations, Circulating Supply dynamics, and, other key network health indicators. 
