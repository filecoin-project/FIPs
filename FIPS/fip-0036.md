...
$SectorInitialConsensusPledge = 30\% \cdot FIL\_CirculatingSupply \cdot \frac{SectorQAP}{max(BaselineTarget, NetworkQAP)}$

We propose changing the calculation to a multiplier of  40%: 

$SectorInitialConsensusPledge = 40\% \cdot FIL\_CirculatingSupply \cdot \frac{SectorQAP}{max(BaselineTarget, NetworkQAP)}$
...
$SectorInitialConsensusPledge = 40% \cdot FIL_CirculatingSupply \cdot \frac{Sector_QAP}{max(BaselineTarget, NetworkQAP)}$
...
1. $adv\_power = adv\_FILplus \cdot FILplus\_multiplier \cdot duration\_multiplier \cdot power\_onboarding \cdot FILplus\_pct$
2. $adv\_power =  0.5 \cdot 10 \cdot (2 \cdot 5) \cdot 50 \cdot 0.05$
3. $honest\_power = 0.5 \cdot 10 \cdot (2 \cdot 5) \cdot 50 \cdot 0.05 + 0.5 \cdot 1 \cdot (2 \cdot 1) \cdot 50 \cdot 0.95$ 
4. $adv\_power\_daily\_pct\_gain = \frac{adv\_power}{18,000 + adv\_power + honest\_power}$ 
5. $adv\_power\_daily\_pct\_gain = 0.7\%$
