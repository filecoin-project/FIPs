...
| Index Key + Value | “sector”       | <SECTOR_NUMER> (int)        |
| Index Key + Value | “unsealed_cid” | <SECTOR_COMMD> (cid)        |
...
sectors can be activated with data that is not onboarded via f-05 Market Actor deals. This means that clients will 
