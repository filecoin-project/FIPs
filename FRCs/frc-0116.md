...
# FRC-0116: JSON-RPC 2.0 HTTP Transport Conventions
...
This specification is derived from the [JSON-RPC 2.0 Transport: HTTP](https://www.simple-is-better.org/json-rpc/transport_http.html) community draft, with modifications to suit the Filecoin ecosystem.
