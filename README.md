...
| [XXXX](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-draft_eip-7939-clz.md) | Add Support for EIP-7939 (CLZ Opcode) in the FEVM | FIP | Aarav Mehta (@aaravm), Michael Seiler (@snissn) | Draft |
