...
|[0067](https://github.com/filecoin-project/FIPs/blob/master/FRCs/frc-0067.md)   | Deal-Making Between SPs and FVM Smart Contracts | FRC  | @aashidham, @raulk, @skottie86, @jennijuju, @nonsense, @shrenujbansal  | Draft  |
