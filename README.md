...
| [XXXX](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0098.md) | Remove Batch Fee For Precommit, Lower BatchBalancer and Remove Gas-limited Constraints | FIP | Irene (@irenegia), AX (@AxCortesCubero), ZX (@zixuanzh) rvagg (@rvagg) | Draft |
