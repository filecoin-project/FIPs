...
| [0064](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0064.md) | Add Parameters to Base Fee Mechanism | FIP | @guy-goren | Withdrawn |
...
| [0112](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0112.md) | Export Sector Liveness Check to FEVM | FIP | @Kubuxu, @lordshashank, @ZenGround0 | Approved | 
| [0113](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0113.md) | secp256r1 (P-256) P256VERIFY Precompile for FEVM | FIP | Aarav Mehta (@aaravm), Michael Seiler (@snissn) | Approved |
| [0114](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0114.md) | Add Support for EIP-7939 (CLZ Opcode) in the FEVM | FIP | Aarav Mehta (@aaravm), Michael Seiler (@snissn) | Approved |
| [0115](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0115.md) | Premium Percentile Target | FIP | William Morriss (@wjmelements), Lin Zexiao (@LinZexiao) | Last Call |
