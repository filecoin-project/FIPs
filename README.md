...
| [XXXX](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-rand-precompile.md) | Add EVM precompile to fetch beacon digest from chain history | FIP | @ZenGround0, Alex North (@anorth) | Draft |
