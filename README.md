...
| [XXXX](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-removePCA.md) | Removal of the ProveCommitAggregate method from the miner actor | FIP | Rod Vagg (@rvagg) | Draft |
