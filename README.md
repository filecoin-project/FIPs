...
| [XXXX](https://github.com/filecoin-project/FIPs/blob/master/FRCs/frc-retrieval-checking-requirements.md) | Delegation of Authority for F3 Parameter Setting | FRC | @Kubuxu @BigLep | Draft |
