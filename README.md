...
<<<<<<< ThatGuyLLC-patch-4
| [0113](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0113.md) | secp256r1 (P-256) P256VERIFY Precompile for FEVM | FIP | Aarav Mehta (@aaravm), Michael Seiler (@snissn) | Last Call |
| [0114](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0114.md) | Add Support for EIP-7939 (CLZ Opcode) in the FEVM | FIP | Aarav Mehta (@aaravm), Michael Seiler (@snissn) | Last Call |
=======
