...
| [0086](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0086.md) | Fast Finality in Filecoin (F3) | FIP | @stebalien, @masih, @mb1896, @hmoniz, @anorth, @matejpavlovic, @arajasek, @ranchalp, @jsoares, @Kubuxu, @vukolic, @jennijuju | Last Call |
...
| [XXX](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-set-the-mining-reserve-to-zero.md) | Set Mining Reserve to Zero | FIP | Jon Victor (@jnthnvctr) | Draft |
